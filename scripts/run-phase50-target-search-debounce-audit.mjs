...
export function runPhase50TargetSearchDebounceAudit(){
  ...
  if(!core.includes("targetSearch.oninput=e=>{if(e?.isComposing)return;scheduleTargetListRenderV150(90)}"))issues.push('target-list search is not IME-aware and debounced');
