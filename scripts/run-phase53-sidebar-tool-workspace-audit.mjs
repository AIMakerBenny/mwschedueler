...
export function runPhase53SidebarToolWorkspaceAudit(){
  ...
  if(!tools.includes("#toolRelations .mws-relation-board{width:min(1450px,100%)!important"))issues.push('relationship grid workspace was not widened to the requested PC width');
  if(!tools.includes("#toolRelations .mws-contact-drawer{max-width:1450px!important"))issues.push('relationship contact drawer no longer aligns with the widened workspace');
