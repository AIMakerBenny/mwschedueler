...
export function runPhase85ContactTabHookSuccessorAudit(){
  ...
  if(contact.includes('function hookTab()')&&!contact.includes('window.mwsContactRuntimeOnTabV130(t)'))issues.push('legacy wrapper does not delegate to the successor hook');
