/* Mawang Scheduler v1.3.0 - isolated post-login UI/runtime loader, Phase 98 */
(()=>{
'use strict';
...
async function start(){
  if(started)return;
  started=true;
  await load('perf-runtime','/assets/perf-runtime.js?v=1.4.0-phase105-achievement-backupfix1','__mwsCf571Optimizer');
  ...
  const quickAddResult=await load('mobile-calendar-quick-add-v130','/assets/mobile-calendar-quick-add-v130.js?v=1.3.0-mobile-calendar-ui-p26','__mwsMobileCalendarQuickAddV130');
  if(!quickAddResult.ok){markCriticalUiFailure(['mobile-calendar-quick-add-v130']);return;}

  const dayDetailResult=await load('mobile-calendar-day-detail-v130','/assets/mobile-calendar-day-detail-v130.js?v=1.3.0-perf34','__mwsMobileCalendarDayDetailV130');
  ...
  optionalResults.push(await load('achievement-media-v1621','/assets/achievement-media-v1621.js?v=1.6.21-phase88','__mwsAchievementMediaRuntimeV1621'));
  optionalResults.push(await loadStyle('achievement-gallery-v1621','/assets/achievement-gallery-v1621.css?v=1.6.21-phase106-detailxl1'));
  optionalResults.push(await load('achievement-gallery-v1621','/assets/achievement-gallery-v1621.js?v=1.6.21-phase104','__mwsAchievementGalleryRuntimeV1621'));
