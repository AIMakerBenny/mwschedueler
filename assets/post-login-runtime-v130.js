...
async function start(){
  ...
  const dayDetailResult=await load('mobile-calendar-day-detail-v130','/assets/mobile-calendar-day-detail-v130.js?v=1.3.0-perf35','__mwsMobileCalendarDayDetailV130');
  ...
  optionalResults.push(await loadStyle('achievement-gallery-v1621','/assets/achievement-gallery-v1621.css?v=1.6.21-phase111'));
  optionalResults.push(await load('achievement-gallery-v1621','/assets/achievement-gallery-v1621.js?v=1.6.21-phase111','__mwsAchievementGalleryRuntimeV1621'));
