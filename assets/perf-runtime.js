...
(()=>{
  ...
  function loadContentPlannerHost(){
    ...
    const s=document.createElement('script');s.id='mwsContentPlannerHostScriptV110';s.src='assets/content-planner-host.js?v=1.4.0-phase105-achievement-navfix1';document.body.appendChild(s);
  }
  ...
  function loadPerfBase(){
    ...
    const s=document.createElement('script');s.id='mwsPerfRuntimeBaseV130';s.src='assets/perf-runtime-base.js?v=1.4.0-phase84';document.head.appendChild(s);
  }
