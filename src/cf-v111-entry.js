...
const TODAY_PEOPLE_WHEEL_SCRIPT='<script src="/assets/today-people-wheel-v117.js?v=1.1.7" data-mws-today-people-wheel-v117="1"></script>';
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/assets/cloud-v5.5.js') {const replacement = new URL('/assets/cloud-v1.1-loader.js?v=1.1.7', request.url);return env.ASSETS.fetch(new Request(replacement.toString(), { method: 'GET', headers: request.headers }));}
    ...
    return htmlResponse(response,html,{'x-mws-steam-picker':'v1.1.3','x-mws-calendar-drag-fix':'v1.1.3','x-mws-ui-fixes':'v1.1.5','x-mws-today-people-wheel':'v1.1.7','x-mws-boss-manager':'v1.1.6'});
  },
};
