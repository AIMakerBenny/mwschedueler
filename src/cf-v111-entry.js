...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/assets/cloud-v5.5.js') {const replacement = new URL('/assets/cloud-v1.1-loader.js?v=1.1.6', request.url);return env.ASSETS.fetch(new Request(replacement.toString(), { method: 'GET', headers: request.headers }));}
    ...
    return htmlResponse(response,html,{'x-mws-steam-picker':'v1.1.3','x-mws-calendar-drag-fix':'v1.1.3','x-mws-ui-fixes':'v1.1.5','x-mws-boss-manager':'v1.1.6'});
  },
};
