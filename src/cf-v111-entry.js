...
const MAJOKU_SIDEBAR_SCRIPT='<script src="/assets/majoku-sidebar-v111.js?v=1.1.2" data-mws-majoku-sidebar="1"></script>';
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/majoku-castle.html') {
      ...
      return htmlResponse(response,html,{'x-mws-majoku-sidebar':'v1.1.2'});
    }
